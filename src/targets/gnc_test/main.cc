...
int main() {
    ...
    while(1) {
        ...
        // p.printk("Acceleration [m/s2]: ");
        // // p.emi(data_icm.accel_m_s2.data(), 3, true);
        // p.printk("Ang. Velocity [deg/s]: ");
        // // p.transmit_floats(data_icm.gyro_dps.data(), 3, true);
        // p.printk("Temperature [ºC]: ");
        // p.printk(data_icm.temp_C);
        ...
        // p.printk("Acceleration [m/s2]: ");
        // p.printk_floats(data_shock.accel_m_s2.data(), 3, true);
        ...
        // p.printk("Magnetic Field [uT]: ");
        // p.printk_floats(mag_data.B_field_uT.data(), 3, true);
